...
class jobItem(propertiesItem):
    def __init__(self, path, param_set, data_set, base='base', minimize=True,
        ...
        self.base = base
        if isinstance(param_set, six.string_types):
        ...
        self.makeIDs()
        self.iniFile_path = "iniFiles" if legacy_mode else input_files_path
        self.iniFile_ext = ".ini" if legacy_mode else ".yaml"
...
##        self.jobItems = None
        ...
        self.iniFile_path = input_files_path
        ...
        for group in settings.groups:
            for data_set in group.datasets:
                for param_set in group.params:
                    item = jobItem(self.batchPath, param_set, data_set, legacy_mode=True)
