"""
.. module:: bicep_keck_2014

:Synopsis: Likelihood of BICEP2/Keck-Array, October 2015 (2014 data)
:Author: Antony Lewis (for the ``CMBLikes`` code) and BICEP2/Keck team
...
To use this likelihood, ``bicep_keck_2014``, you simply need to mention it in the
...
.. literalinclude:: ../cobaya/likelihoods/bicep_keck_2014/bicep_keck_2014.yaml
   :language: yaml
...
.. code-block:: yaml
   ...
   likelihood:
     bicep_keck_2014:
       path: /path/to/likelihoods/bicep_keck_2014
...
class bicep_keck_2014(_cmblikes_prototype):
