...
from cobaya.input_processing import get_used_components
...
from cobaya.typing_conventions import InputDict, InfoDict
...
def install_script(args=None):
    ...
    for f in arguments.files_or_components:
        if f.lower() == "cosmo":
            ...
            from cobaya.input_processing import load_input
            infos += [load_input(f)]
